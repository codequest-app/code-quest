...
- [x] `DATABASE_SQLITE_URL` only — verify boot works, writes go to SQLite.
- [x] `DATABASE_URL` only — verify boot works, writes go to MySQL.
- [x] Both unset — verify clear error message.
- [x] Both set — verify dual-write.
