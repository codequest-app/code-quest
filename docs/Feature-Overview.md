...
RPG-CLI 採用**雙場景系統**，模擬傳統 RPG 的「探索」和「戰鬥」兩種狀態。
...
**Prompt 類型識別**:
- **任務型**（進入戰鬥）：包含動作關鍵字（修復、創建、重構...）
- **對話型**（保持探索）：知識問答、解釋說明、閒聊

詳細設計見：`docs/design/Scene-System-Design.md`
