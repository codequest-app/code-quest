...
The resumable middleware provides automatic reconnect event recovery for WsTransport connections. It manages a registry of ResumableSockets keyed by sessionKey, handles rebind on reconnect, triggers replay on RESUME_EVENT, and auto-cleans expired sessions via TTL.
