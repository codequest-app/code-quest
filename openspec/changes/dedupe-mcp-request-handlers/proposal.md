...
- Affected file: `packages/server/src/socket/handlers/mcp.ts`.
- Tests: `packages/server/src/__tests__/mcp.test.ts` must stay green without `expect` modification.
