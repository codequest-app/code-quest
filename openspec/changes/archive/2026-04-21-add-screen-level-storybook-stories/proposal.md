...
- Add reusable fixture module `packages/client/src/test/story-fixtures.ts` holding shared mock messages, sessions, pending controls, projects
...
- **Affected code**:
  - New: `packages/client/src/test/story-workspace-decorator.tsx` (new decorator)
  - New: `packages/client/src/test/story-fixtures.ts` (shared fixtures)
  - New: `packages/client/src/App.stories.tsx`
  - Modified: `packages/client/src/components/WorkspaceLayout.stories.tsx`, `ChatPanel.stories.tsx`
