...
- `apps/web/src/components/WorkspaceLayout.tsx` — breakpoint 切換邏輯
- `apps/web/src/components/ActivityBar.tsx` — mobile 下隱藏
- `apps/web/src/components/TabBar.tsx` — mobile 下調整或隱藏
- `apps/web/src/components/MessageList.tsx` — 加 max-width
- `apps/web/src/components/ChatPanel.tsx` — RawEventPanel 改 overlay
- 新增 `apps/web/src/components/MobileNav.tsx`
- 新增 `apps/web/src/hooks/useBreakpoint.ts`
