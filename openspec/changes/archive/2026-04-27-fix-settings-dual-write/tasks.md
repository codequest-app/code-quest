...
- [x] Boot server with `RAW_EVENTS_DRIVERS=sqlite,mysql`.
- [x] Trigger any settings write (change model / permissionMode in UI).
- [x] Verify both SQLite + MySQL `settings` tables receive the row.
